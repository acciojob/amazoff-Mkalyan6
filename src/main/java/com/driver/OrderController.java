...
public class OrderController {
    ...
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam("itemId") String orderId, @RequestParam("personId") String partnerId){
    ...
    public ResponseEntity<Integer> getOrderCountByPartnerId(@PathVariable("partnerId") String partnerId){
        ...
        Integer orderCount = service.getOrderCountByPartnerIdz(partnerId);
